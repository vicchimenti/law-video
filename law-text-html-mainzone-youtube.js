 ...
 */
 ...
 try {
      ...
      * 
      * */ 
     let beginningHTML = '<div class="embeddedVideoWrapper contentItem ytv col card border-1 rounded-0" id="ytvmain' + ytvDict.contentId.content + '" data-position-default="Main" data-position-selected="Main">';
     let endingHTML = '</div>';
    ...
    * */
    ...
    /***
     ...
     let openCardFooter = (ytvDict.footer.content)
                          ? '<div class="card-footer border-1 rounded-0">'
